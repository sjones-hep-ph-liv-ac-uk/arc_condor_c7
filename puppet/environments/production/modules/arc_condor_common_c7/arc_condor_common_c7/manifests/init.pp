class arc_condor_common_c7 (
) inherits arc_condor_common_c7::params {

  # Security
  file { "/etc/grid-security/grid-mapfile": source => "puppet:///modules/arc_condor_common_c7/grid-mapfile", mode => "644", }
  ...
  file { "/root/scripts/arcServicesStop.sh": source => "puppet:///modules/arc_condor_common_c7/arcServicesStop.sh", mode => "755", }
  file { "/root/scripts/arcServicesStart.sh": source => "puppet:///modules/arc_condor_common_c7/arcServicesStart.sh", mode => "755", }
  file { "/root/scripts/arcServicesStatus.sh": source => "puppet:///modules/arc_condor_common_c7/arcServicesStatus.sh", mode => "755", }
  file { "/root/scripts/arcServicesMakeSure.sh": source => "puppet:///modules/arc_condor_common_c7/arcServicesMakeSure.sh", mode => "755", }
  ...
  file { "/root/scripts/boostJobMemoryLimit.pl": source => "puppet:///modules/arc_condor_common_c7/boostJobMemoryLimit.pl", mode => "755", }
  ...
  file { "/root/scripts/cleanJobstatusDirs.sh": source => "puppet:///modules/arc_condor_common_c7/cleanJobstatusDirs.sh", mode => "755", }
  ...
  file { "/root/scripts/gmmon.py":
    ...
    source => "puppet:///modules/arc_condor_common_c7/gmmon.py",
    mode => "755"
  }
  cron { "gmmon":
  ...
  file { "/usr/libexec/arc/jura_dummy":
    source => "puppet:///modules/arc_condor_common_c7//jura_dummy",
    owner => "root",
    mode => "755",
  }
  package { "apel-client": ensure => installed , }
  file { "/root/scripts/send_accounting_data.sh": source => "puppet:///modules/arc_condor_common_c7/send_accounting_data.sh", owner => "root", mode => "755", }
  ...
  file { "/root/scripts/beef_up_mcore_userprio.sh": source => "puppet:///modules/arc_condor_common_c7/beef_up_mcore_userprio.sh", owner => "root", mode => "755", }
  file { "/root/scripts/show_spares.pl": source => "puppet:///modules/arc_condor_common_c7/show_spares.pl", owner => "root", mode => "755", }
  file { "/root/scripts/show_all_spares.sh": source => "puppet:///modules/arc_condor_common_c7/show_all_spares.sh", owner => "root", mode => "755", }
  file { "/root/scripts/listUglySisters.pl": source => "puppet:///modules/arc_condor_common_c7/listUglySisters.pl", owner => "root", mode => "755", }
  file { "/root/scripts/condor_q_cores.pl": source => "puppet:///modules/arc_condor_common_c7/condor_q_cores.pl", owner => "root", mode => "755", }
  file { "/root/scripts/nodes.sh": source => "puppet:///modules/arc_condor_common_c7/nodes.sh", owner => "root", mode => "755", }
  file { "/root/scripts/startJobsOff.sh": source => "puppet:///modules/arc_condor_common_c7/startJobsOff.sh", owner => "root", mode => "755", }
  file { "/root/scripts/startJobsOn.sh": source => "puppet:///modules/arc_condor_common_c7/startJobsOn.sh", owner => "root", mode => "755", }
  file { "/root/scripts/startJobsShow.sh": source => "puppet:///modules/arc_condor_common_c7/startJobsShow.sh", owner => "root", mode => "755", }
  file { "/root/scripts/startJobsShowAll.sh": source => "puppet:///modules/arc_condor_common_c7/startJobsShowAll.sh", owner => "root", mode => "755", }
  file { "/root/scripts/onlyMulticoreOff.sh": source => "puppet:///modules/arc_condor_common_c7/onlyMulticoreOff.sh", owner => "root", mode => "755", }
  file { "/root/scripts/onlyMulticoreOn.sh": source => "puppet:///modules/arc_condor_common_c7/onlyMulticoreOn.sh", owner => "root", mode => "755", }
  file { "/root/scripts/onlyMulticoreShow.sh": source => "puppet:///modules/arc_condor_common_c7/onlyMulticoreShow.sh", owner => "root", mode => "755", }
  file { "/root/scripts/onlyMulticoreShowAll.sh": source => "puppet:///modules/arc_condor_common_c7/onlyMulticoreShowAll.sh", owner => "root", mode => "755", }
  file { "/root/scripts/restart": source => "puppet:///modules/arc_condor_common_c7/restart", owner => "root", mode => "755", }
  file { "/root/scripts/removeUglySisters.sh": source => "puppet:///modules/arc_condor_common_c7/removeUglySisters.sh", owner => "root", mode => "755", }
  ...
  file { "/usr/share/arc/glue-generator.pl":
    source => "puppet:///modules/arc_condor_common_c7//glue-generator.pl",
    owner => "root", 
    mode => "755",
  }
  ...
  file { "/usr/local/bin/scaling_factors_plugin.py":
    source => "puppet:///modules/arc_condor_common_c7/scaling_factors_plugin.py",
    mode => "755",
  }
  file { "/usr/local/bin/debugging_rte_plugin.py":
    source => "puppet:///modules/arc_condor_common_c7/debugging_rte_plugin.py",
    require => File ["/var/spool/arc/debugging"],
    mode => "755",
  }
  file { "/usr/local/bin/default_rte_plugin.py":
    source => "puppet:///modules/arc_condor_common_c7/default_rte_plugin.py",
    owner => "root",
    mode => "755",
  }
