class arc_condor_runtime_c7(
) inherits arc_condor_runtime_c7::params {
  ...
  file { "/etc/arc/runtime/ENV/GLITE": source => "puppet:///modules/arc_condor_runtime_c7/GLITE", require => File ["/etc/arc/runtime/ENV"], mode => "755", }
